...
/// <summary>
/// 아이템 상점과의 상호작용을 처리하는 컴포넌트
/// 단일 책임: 플레이어와 상점 간의 상호작용 감지 및 UI 표시
/// </summary>
public class ItemShopInteractor : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            playerInRange = true;
            Debug.Log("아이템 상점 범위에 들어왔습니다. E키를 눌러 상점을 열어보세요.");
        }
    }
    ...
    {
        if (!playerInRange || itemShop == null) return;
